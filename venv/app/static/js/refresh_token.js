   ...
   */
  var CLIENT_ID = '6380402191-jqh5gfvn2oh3urja7smeeuo74pfduffl.apps.googleusercontent.com';
  var CLIENT_SECRET = 'n9PJJNA3UXjgygKrh0qx_3AB';

  // Enter required scopes, e.g. ['https://www.googleapis.com/auth/drive']
  var SCOPES = ['http://localhost:5000'];
  ...
  REDIRECT_URI = 'https://oauth-redirect.googleusercontent.com/r/avid-sunset-194907'
  REQUESTED_SCOPES ='http://localhost:5000'
  ...
  function generateAuthUrl() {
    ...
    var request = xhr.open('GET', 'https://accounts.google.com/o/oauth2/auth?client_id='+CLIENT_ID+'&redirect_uri='+REDIRECT_URI+'&state=offline&response_type=code');
    console.log(
        'Browse to the following URL: ' + AUTH_URL + '?' + xhr.statusText);
  }
  ...
  function generateRefreshToken() {
    ...
    var xhr = new XMLHttpRequest();
    // 'https://accounts.google.com/o/oauth2/auth?client_id=%s&redirect_uri=%s&state=offline&scope=%s&response_type=code'%(GOOGLE_CLIENT_ID, REDIRECT_URI, REQUESTED_SCOPES)
    var response = xhr.open('POST', 'https://accounts.google.com/o/oauth2/auth?client_id='+CLIENT_ID+'&redirect_uri='+REDIRECT_URI+'&rstate=offline&response_type=code');
